...
public class billdetail1 extends javax.swing.JFrame {
   ...
   public void display()
    {
        try{
        String query="select Customer_id,Customer_Name,Customer_Address,Bill_no,product_id,Quantity,Amount_paid from customer_info";
...
System.exit(0);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(billdetail1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new billdetail1().setVisible(true);
            }
        });
    }
